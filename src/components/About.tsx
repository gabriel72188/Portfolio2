      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <Card className="p-8 bg-card border-border">
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-primary">Experiencia</h3>
                <p className="text-muted-foreground">2 años desarrollando aplicaciones web</p>
              </div>
              
              <div>
                <h3 className="text-xl font-semibold mb-2 text-primary">Educación</h3>
                <p className="text-muted-foreground">Técnico en desarrollo de aplicaciones web</p>
              </div>
